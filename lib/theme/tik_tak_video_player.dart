...
class TikTakVideoPlayer extends StatefulWidget {
  const TikTakVideoPlayer({
    @required this.path,
  ...
  @override
  State<StatefulWidget> createState() => _TikTakVideoPlayerState();
}

class _TikTakVideoPlayerState extends State<TikTakVideoPlayer> {
